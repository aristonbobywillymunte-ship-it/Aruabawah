...
<body class="min-h-screen bg-[#f7f9ff] text-slate-800 font-sans">
    <div class="flex min-h-screen flex-col lg:flex-row" x-data="{ mobileMenuOpen: false }">
        ...
        <!-- Main Content Area -->
        <div class="flex min-w-0 flex-1 flex-col lg:h-screen lg:max-h-screen lg:overflow-hidden">
            <!-- Header -->
            ...
            <main class="w-full flex-1 overflow-y-auto px-4 pb-10 pt-6 sm:px-6 lg:px-8 lg:pt-8 min-h-0 focus:outline-none outline-none lg:max-h-[calc(100vh-140px)] flex flex-col">
                <div class="mx-auto w-full max-w-[1440px] flex-1 flex flex-col min-h-0">
                    @yield('content')
                </div>
            </main>
        </div>
