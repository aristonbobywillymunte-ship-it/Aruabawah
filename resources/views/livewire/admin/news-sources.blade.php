        ...
        <div wire:key="news-source-confirm-delete-modal" class="fixed inset-0 z-[999] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm px-4 py-6">
            <div class="w-full max-w-sm rounded-[24px] bg-white p-6 shadow-2xl text-left space-y-4 overscroll-contain">
                ...
                <div class="flex items-center justify-end gap-3 pt-2">
                    <button wire:click="cancelDelete" wire:loading.attr="disabled" wire:target="deleteConfirmed" class="h-10 rounded-xl border border-slate-200 px-5 text-xs font-bold text-slate-600 hover:bg-slate-50 transition cursor-pointer disabled:opacity-50">Batal</button>
                ...
                <div class="px-8 py-6 space-y-5 overflow-y-auto flex-1 bg-white overscroll-contain">
                    ...
                    @else
                        ...
                        <div class="flex flex-col items-center justify-center py-16 px-4 text-center">
                            ...
                            <p class="text-[11px] text-slate-400 mt-1 max-w-xs leading-normal">Tidak ada data portal berita manual yang terdaftar di tempat sampah saat ini.</p>
                        </div>
                    @endif
                </div>
