...
<div class="mx-auto w-full max-w-7xl space-y-6 font-sans">
    {{-- Global Loading State for testConnection --}}
    <div wire:loading.flex wire:target="testConnection" class="fixed inset-0 z-[9999] items-center justify-center bg-slate-950/20 backdrop-blur-[2px]">
        <div class="bg-white px-5 py-3 rounded-2xl shadow-xl flex items-center gap-3 border border-slate-100 animate-fade-in">
            ...
            <span class="text-xs font-bold text-slate-700">Menguji koneksi API Apify...</span>
        </div>
    </div>
