...
>
    ...
    <div class="relative bg-white border border-slate-200/60 rounded-2xl shadow-sm overflow-hidden min-h-[300px]">
        ...
        <div wire:loading.delay wire:target="setTab, retryAiState, retryAllFailedAiStates, deleteAiState, retryNotification, deleteNotification, clearAllPendingAiStates, filterProject, filterPlatform, filterAiState, filterStatus, filterRisk, search"
             class="absolute inset-0 z-20 flex items-center justify-center bg-white/70 backdrop-blur-[1px] rounded-2xl">
            <div class="flex flex-col items-center gap-3 bg-white rounded-2xl px-7 py-5 shadow-xl border border-slate-100">
                <svg class="animate-spin h-8 w-8 text-[#1fa387]" fill="none" viewBox="0 0 24 24">
                    <circle class="opacity-20" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                    <path class="opacity-80" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
                <span class="text-[11px] font-bold text-slate-600 tracking-wide">Memuat data...</span>
            </div>
        </div>
