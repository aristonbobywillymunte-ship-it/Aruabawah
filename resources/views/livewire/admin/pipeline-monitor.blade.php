...
>
    ...
    <div class="relative bg-white border border-slate-200/60 rounded-2xl shadow-sm min-h-[250px]">
        {{-- Loading Overlay --}}
        <div wire:loading.delay class="absolute inset-0 z-10 flex flex-col items-center justify-center bg-white/95 backdrop-blur-[3px] transition-all duration-200 rounded-2xl">
