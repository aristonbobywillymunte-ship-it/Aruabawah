<div class="relative" x-data="{ open: false }">
    ...
    <button 
        type="button" 
        @click="open = !open"
        class="relative w-10 h-10 flex items-center justify-center text-slate-550 hover:text-[#1fa387] hover:bg-[#1fa387]/5 rounded-full z-[60] active:scale-95 transition-all duration-200 cursor-pointer" 
        title="Notifikasi"
    >
        ...
        @if($unreadCount > 0)
            <span class="absolute top-2.5 right-2.5 flex h-2 w-2">
                ...
                <span class="relative inline-flex rounded-full h-2 w-2 bg-rose-550 border border-white"></span>
            </span>
        @endif
    </button>
