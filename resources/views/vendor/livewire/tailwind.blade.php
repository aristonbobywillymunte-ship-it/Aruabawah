@php
if (! isset($scrollTo)) {
    $scrollTo = false; // Disable scroll to top by default
}
                                    ...
                                    <span wire:key="paginator-{{ $paginator->getPageName() }}-page{{ $page }}">
                                        @if ($page == $paginator->currentPage())
                                            <span aria-current="page">
                                                <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-[#1fa387] border border-[#1fa387] cursor-default leading-5  ">{{ $page }}</span>
                                            </span>
                                        @else
