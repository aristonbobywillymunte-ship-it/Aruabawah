...
@else
    ...
    <div class="space-y-1.5">
        <div class="flex items-center justify-between">
            ...
            <span wire:loading.flex wire:target="search" class="hidden items-center gap-1 text-[10px] font-semibold text-[#1fa387]">
                <svg class="animate-spin h-3 w-3 text-[#1fa387]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div class="relative">
            <input 
                ...
                type="text" 
                placeholder="Cari..."
                class="w-full bg-[#f8f9fa] border border-slate-200 focus:border-[#1fa387] focus:ring-1 focus:ring-[#1fa387] rounded-xl pl-3 pr-9 py-2.5 text-xs text-slate-800 placeholder-[#727785] transition"
            >
            <!-- Idle Search Icon -->
            <svg wire:loading.remove wire:target="search" class="w-4 h-4 text-slate-400 absolute right-3 top-3 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
            </svg>
            <!-- Spinner Icon in Input when typing/searching -->
            <div wire:loading.flex wire:target="search" class="hidden absolute right-3 top-3 pointer-events-none items-center">
