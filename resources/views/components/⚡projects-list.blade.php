                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        @if(auth()->check())
                            <div 
                                ...
                                class="dashed-border min-h-[440px] flex flex-col items-center justify-center p-8 text-center group cursor-pointer hover:bg-white/50 transition-all duration-300 border-2 border-dashed border-slate-300 rounded-2xl"
                            >
                                ...
                                <h3 class="text-lg font-hanken font-bold text-slate-800 mb-2">Buat Proyek Baru</h3>
                                <p class="text-slate-400 text-sm max-w-[200px] leading-relaxed">
                        ...
                        @foreach($projects as $idx => $project)
                            <article class="bg-white rounded-2xl border border-slate-200 p-6 flex flex-col h-full shadow-[0_4px_20px_-2px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] transition-all">
                                ...
                                <div class="mt-auto" x-data="{ openingProject: false }">
                                    <a 
                                        href="?project={{ base64_encode($project['id']) }}&tab=cGVueWVidXRhbg=="
                                        x-on:click.prevent="openingProject = true; window.location.href = '?project={{ base64_encode($project['id']) }}&tab=cGVueWVidXRhbg==';"
                ...
                >
                    <div class="bg-white rounded-2xl w-full max-w-lg shadow-2xl border border-slate-100 overflow-hidden">
                        <div class="px-8 py-6 border-b border-slate-100 flex items-center justify-between">
                            ...
                            <button wire:click="closeModals" class="text-slate-400 hover:text-slate-600 transition-colors">
                    ...
                    <div class="bg-white rounded-2xl w-full max-w-2xl shadow-2xl border border-slate-100 overflow-hidden">
                        ...
                        <div class="px-8 py-4 bg-slate-50 border-t border-slate-100 flex justify-end">
                            <button
                                type="button"
                                wire:click="closeModals"
                                class="px-5 py-2 bg-slate-200 hover:bg-slate-350 text-slate-700 font-bold rounded-xl text-xs transition"
                            >
                                Tutup
                            </button>
                        </div>
