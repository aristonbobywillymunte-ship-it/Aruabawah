...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        \App\Models\AiPromptTemplate::updateOrCreate(
            ...
            [
                'source_type' => 'article',
                'system_prompt' => \App\Models\AiPromptTemplate::articleAiSystemPrompt(),
                'user_prompt_template' => \App\Models\AiPromptTemplate::articleAiUserPromptTemplate(),
                'output_schema' => \App\Models\AiPromptTemplate::articleAiOutputSchema(),
                'is_active' => true,
                'is_default' => true,
            ]
        );
        ...
        \App\Models\AiPromptTemplate::updateOrCreate(
            ...
            [
                'source_type' => 'social',
                'system_prompt' => \App\Models\AiPromptTemplate::socialAiSystemPrompt(),
                'user_prompt_template' => \App\Models\AiPromptTemplate::socialAiUserPromptTemplate(),
                'output_schema' => \App\Models\AiPromptTemplate::socialAiOutputSchema(),
                'is_active' => true,
                'is_default' => true,
            ]
        );
